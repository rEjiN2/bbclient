...
const columnsData = [
    {
      ...
      caption: 'OUR VALUE',
      content: 'Consulting is the secret to unlocking your vision.',
    },
    {
      ...
      content: 'Conceptualize, design, and deliver exceptional execution.',
    },
    {
      imageSrc: 'https://web.moxcreative.com/ventuure/wp-content/uploads/sites/20/2023/03/top-view-of-business-women-comparing-financial-graphs-with-management-statistics-expertise.jpg',
      caption: 'INVESTMENT STRATEGY',
      content: 'Help our clients reach their full potential.',
    },
  ];
const AboutColumn = () => {
  return (
