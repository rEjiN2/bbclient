...
const ProjectItems = () => {
 ...
 <Grid container spacing={5} alignItems="center" justifyContent="center">
        ...
        <Grid item xs={12} md={6}>
          ...
          <Button sx={{background:'linear-gradient(to right, #73c8a9, #373b44)',borderRadius:'5px',fontWeight:'bold',textTransform:'none',color:'#fff',marginTop:'1rem'}} >اكتشف المزيد</Button>
        </Grid>
          ...
          <Grid item xs={12} sm={6} md={4} key={index}>
            <Card style={{borderRadius:'10px'}}>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'right', padding: 2 }}>
                <Button style={{background:'linear-gradient(to right, #73c8a9, #373b44)',borderRadius:'5px',fontWeight:'500',textTransform:'none'}} size="small"  variant="contained">تعلم المزيد</Button>
              </Box>
            </Card>
          </Grid>
        ))}
